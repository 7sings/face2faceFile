export const elements = {
  ...
  localVideoPlaceholder: document.querySelector('#localVideoPlaceholder'),
  remoteVideoPlaceholder: document.querySelector('#remoteVideoPlaceholder'),
  startCallBtn: document.querySelector('#startCallBtn'),
  hangupCallBtn: document.querySelector('#hangupCallBtn'),
  ...
  sendOverallBar: document.querySelector('#sendOverallBar'),
  sendOverallMeta: document.querySelector('#sendOverallMeta'),
  sendList: document.querySelector('#sendList'),
  receiveOverallBar: document.querySelector('#receiveOverallBar'),
  receiveOverallMeta: document.querySelector('#receiveOverallMeta'),
